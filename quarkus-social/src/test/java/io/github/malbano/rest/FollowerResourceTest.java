...
import io.github.malbano.quarkussocial.rest.SeguidorResource;
...
class FollowerResourceTest {
    ...
    @Inject
    SeguidorRepository followerRepository;
    ...
    void setUp() {
        ...
        //cria um follower
        var followerEntity = new Seguidor();
        followerEntity.setSeguidor(follower);
    ...
    public void sameUserAsFollowerTest(){
        ...
        var body = new SeguidorRequest();
        body.setSeguidorId(userId);
    ...
    public void listFollowersTest(){
        ...
        var followersCount = response.jsonPath().get("quantidadeSeguidores");
